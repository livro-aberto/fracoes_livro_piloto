...
%{Atividade 1}  
\begin{objetivos}[label=chap1-ativ1]{}{}
\begin{itemize} %s
...
\begin{objetivos}[label=chap1-ativ2]{}{}
\begin{itemize} %s
...
\begin{objetivos}[label=chap1-ativ3]{}{}
\begin{itemize} %s
...
Uma maneira de se cortar o barbante é dobrar ao meio, cortar. Depois dobrar novamente cada uma das partes e cortar, obtendo quatro partes iguais, como ilustrado na figura a seguir.
  \begin{center}
  \includegraphics[width=200pt, keepaspectratio]{../figuras/licao01/barbantes-agnes.png}
  \end{center}
\end{solucao}
\end{multicols}
...
\begin{multicols}{2}
\begin{objetivos}[label=chap1-ativ4]{}{}
...
\clearpage
\begin{objetivos}[label=chap1-ativ5]{}{}
\begin{itemize}
...
\begin{solucao}{}{}
  \begin{enumerate}[a)]
  \item O triângulo dado é um terço da figura a seguir porque ela pode ser expressa pela reunião, sem sobreposição, de 3 desses triângulos como indicado na figura.
  \begin{center}
  % trapezio
  \begin{tikzpicture}%[scale=20]
\filldraw [fill=cbpink] (0,0) -- (120:1) -- ++(180:1) -- +(240:1) -- cycle;
\draw (180:1) --+ (60:1);
\draw (180:1) --+ (120:1);
\end{tikzpicture}
  \end{center}
    \item O triângulo dado é um quarto das figuras a seguir. A justificativa é que elas podem ser decompostas como a justaposição de 4 desses triângulos como indicado na figura.
\begin{center}
    %paralelogramo
\begin{tikzpicture}%[scale=20]
\filldraw [fill=cbgreen]  (120:1) -- ++(180:1) -- ++(240:1) -- ++(0:2) -- ++(60:1) -- cycle;
\draw (180:1) --+ (60:1) -- (0,0);
\draw (180:1) --+ (120:1);
\end{tikzpicture}
\medskip
...
\filldraw [fill=cbbrown] (0,0) -- (120:1) -- (180:1) -- cycle;
\draw (120:.5) --+ (180:.5)--+ (240:.5)--cycle;
\end{tikzpicture}
\end{center}
\item O triângulo dado é um quinto da figura a seguir.
\begin{center}
\begin{tikzpicture}%[scale=20]
\filldraw [fill=cbgreen]  (120:1) -- ++(180:1) -- ++(240:1) -- ++(0:2) -- ++(60:1) -- cycle;
\draw (180:1) --+ (60:1) -- (0,0);
\draw (180:1) --+ (120:1);
\filldraw [fill=cbgreen] (0,0) -- (1,0) --+ (120:1) --cycle;
\end{tikzpicture}
\end{center}
      \item O triângulo cinza é um oitavo da figura amarela, veja:
\begin{center}
      %Bandeirinha
\begin{tikzpicture}[xscale=-1]
\filldraw [fill=cbyellow]  (120:1) -- ++(180:1) -- ++(240:1) -- ++(360:2) -- ++(60:1) -- cycle;
\filldraw [fill=cbyellow,yscale=-1]  (120:1) -- ++(180:1) -- ++(240:1) -- ++(360:2) -- ++(60:1) -- cycle;
\draw (180:1) --+ (60:1) -- (0,0);
\draw (180:1) --+ (120:1);
\draw[yscale=-1] (180:1) --+ (60:1) -- (0,0);
\draw[yscale=-1] (180:1) --+ (120:1);

\end{tikzpicture}
\end{center}
        \item O triângulo cinza é metade do retângulo porque cortando um triângulo ao meio como indicado na figura, pode-se justapor o triângulo cinza com duas de suas metades para compor o retângulo laranja. 
         \begin{center}
% triangulo cinza
\begin{tikzpicture}%[scale=20]
\filldraw [fill=cbgray] (60:0) -- (120:1) -- (180:1) -- cycle;
\draw[dashed] (120:1) -- (180:.5);
\end{tikzpicture}
\medskip
%retangulo laranja
\begin{tikzpicture}%[scale=20]
\filldraw [fill=cborange] (0,0) -- (1,0) -- (1,1.732/2) -- (0,1.732/2) -- cycle;
\draw (.5,0) --+ (120:1);
\draw (.5,0) --+ (60:1);
\end{tikzpicture}
         \end{center}
...
\newpage
\begin{objetivos}[label=chap1-ativ6]{}{}
\begin{itemize} %s
...
\begin{objetivos}[label=chap1-ativ7]{}{}
  \begin{itemize} %d
    \item       Recompor a unidade a partir de uma fração unitária dada em modelos contínuos.
...
\begin{multicols}{2}
  ...
  \begin{objetivos}[label=chap1-ativ8]{}{}
\begin{itemize} %s
...
\begin{objetivos}[label=chap1-ativ9]{}{}
\begin{itemize} %s
...
\begin{objetivos}[label=chap1-ativ10]{}{}
\begin{itemize} %s
...
\begin{objetivos}[label=chap1-ativ11]{}{}
\begin{itemize}
...
\begin{objetivos}[label=chap1-ativ12]{}{}
  \begin{itemize} %s
...
\pagebreak
\begin{objetivos}[label=chap1-ativ13]{}{}
\begin{itemize} %s
