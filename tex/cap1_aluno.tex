...
\begin{center}
 \begin{tikzpicture}[scale=5]
  ...
  % terceiro de cima    
\fill[attention] (0,0) rectangle (4,6);
  ...
  % quarto de cima
  \fill[OliveGreen, opacity=.5] (5,0) rectangle (9,6);
...
\begin{tikzpicture}[scale=5]
  ...
  \begin{scope}[xshift=-28.5]
    % primeiro debaixo
  \fill[Purple, opacity=.5] (10,0) rectangle (14,6);  
  ...
  % 2 debaixo
  \fill[yellow] (15,0) rectangle (19,6);
 ...
 \draw (15,3) -- (19,6);
  \end{scope}
  % 3 debaixo
  \fill[gray, opacity=.8] (10,0) rectangle (14,6);
