...
\begin{tikzpicture}[scale=5]
 ...
 \draw (15,3) -- (19,6);
  ...
  \draw[fill=common, fill opacity=.3] (0,0) rectangle (4,6);
  \draw (1,0) -- (1,6);
  \draw (2,0) -- (2,6);
  \draw (2,3) -- (4,3);
  \end{scope}
...
\filldraw [fill=attention, draw=black] (0:2 cm) -- (90:2 cm) -- (180:2 cm) -- (0,0) -- ( (270:2 cm) --cycle;
\fill[common, fill opacity=.3] (180:2 cm) -- (270:2cm) -- (0,0) -- cycle;
...
Na tabela a seguir, em cada linha, a primeira coluna mostra figuras que são frações de uma unidade. Na segunda, o nome que usamos. Na terceira coluna de cada linha, desenhe uma unidade juntando frações como a dada.
