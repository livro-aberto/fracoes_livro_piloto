...
Três amigos vão repartir uma barra de chocolate. Um deles sugere a seguinte divisão: 
  ...
  \begin{center}
    \includegraphics[width=300pt, keepaspectratio]{..//media/cap1/secoes//pngs_licao_01/ativ1_fig01.png}  
  \end{center}
...
A barra de chocolate, a pizza e o pedaço de barbante foram partidos {\bf em partes iguais}. 
...
\includegraphics[scale=.6]{../media/cap1/secoes/pngs_licao_01/paralelepipedo_tercos.png}
}
...
Nas figuras a seguir, um mesmo círculo azul aparece diferentemente dividido em partes iguais e colorido em vermelho. 
\begin{enumerate} [\quad a)] %s
