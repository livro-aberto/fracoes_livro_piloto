...
Essa mesma forma de nomear vale para outras frações.
\begin{itemize}
...
\end{itemize}
Como você pôde observar, a nomeação de uma fração depende do denominador da fração. Para ler a fração deve-se ler o {\bf número} do numerador seguido do {\bf nome que identifica a equipartição da unidade, e que está indicado no denominador}, nessa ordem. Veja:
...
Na tabela a seguir, pinte cada figura de modo que a parte pintada seja a fração da figura indicada na coluna à esquerda e na mesma linha. Indique também, usando notação simbólica matemática, qual fração da figura não foi pintada.
