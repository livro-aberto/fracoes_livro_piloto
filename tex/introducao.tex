...
Corrija diretamente no arquivo \url{https://github.com/livro-aberto/fracoes_livro_piloto/tree/master/tex}.
Para comentários gerais use o site ou a wiki da versão digital (\url{umlivroaberto.com}).
Para contactar a organização do projeto escreva para \url{livroaberto@impa.br}.
